...
function addInformations(data, dayWorked) {
  //console.log(data)
    data.map((element,index) =>{
      element["marginPerCent"]={value:cal.marginPerCent(element.price.value, element.cost.value, element.charges.value)}
      element["margin"]={value:cal.margin(element.price.value, element.cost.value, element.charges.value)}
      element["business"]={value:cal.business(element.price.value, element.cost.value, dayWorked[index])}
      element["totalMargin"]={value:cal.totalMargin(element.price.value, element.cost.value, element.charges.value, dayWorked[index])}
      })
