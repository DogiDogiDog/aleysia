...
function getCalendarFromConsultants() {
  return queryDatabase("SELECT  janvier, fevrier, mars, avril, mai, juin, juillet, aout, septembre, octobre, novembre, decembre FROM consultant, calendar  where calendar.employe_id=consultant.id")
    .then(data => {
      return data
    })
}
